...
public class Search {
     ...
     */
    private static final String apiKey = "AIzaSyDSK2akiauyjOckJxEdOsxPoiufL6cx1PY";
    ...
    public Search(long NUMBERS) {
        this.NUMBER_OF_VIDEOS_RETURNED = NUMBERS;
    }
    ...
    public ArrayList<Video> Run(String queryTerm) {
        try {
    ...
    private static ArrayList<Video> prettyPrint(Iterator<SearchResult> iteratorSearchResults, String query) {
        ...
        while (iteratorSearchResults.hasNext()) {
            ...
            if (rId.getKind().equals("youtube#video")) {
                ...
                videos.add(new Video(rId.getVideoId(),singleVideo.getSnippet().getTitle(),thumbnail.getUrl()));
            }
        }
        return videos;
    }
